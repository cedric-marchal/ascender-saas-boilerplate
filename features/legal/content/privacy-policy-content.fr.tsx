...
type PrivacyPolicyContentFrProps = {
  appName: string;
};
 ...
 */
function PrivacyPolicyContentFr({ appName }: PrivacyPolicyContentFrProps) {
  return (
    <div className="prose prose-zinc dark:prose-invert max-w-none">
      <section>
        <h2>Introduction</h2>
        <p>
          La présente politique de confidentialité décrit comment {appName}
      ...
      <section>
        ...
        <ul>
          <li>
            <strong>Informations de compte :</strong> nom, adresse email, mot de
            passe lors de votre inscription
          </li>
          <li>
          ...
          <li>
            ...
            sécurisée par notre prestataire Stripe
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            <strong>Données d'utilisation :</strong> pages visitées, durée de
      ...
      <section>
        ...
        <ul>
          <li>
            ...
            paiement (Stripe), emails (Resend), base de données (Neon), stockage
            de fichiers (Cloudflare R2), mise en cache (Upstash)
          </li>
          <li>
            <strong>Autorités :</strong> si requis par la loi ou pour protéger
            nos droits
          </li>
        </ul>
        <p>
          Ces prestataires sont contractuellement tenus de protéger vos données
          et de ne les utiliser que pour les services qu'ils nous fournissent.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          ...
          transferts de données vers ces pays sont encadrés par des garanties
      ...
      <section>
        ...
        <p>Pour exercer ces droits, contactez-nous à : contact@example.com</p>
        <p>
      ...
      <section>
        ...
        <p>
          Vous pouvez gérer vos préférences de cookies à tout moment via l'icône
          de cookie en bas à droite de la page ou dans les paramètres de votre
          navigateur.
        </p>
      </section>
